    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('assignments.update', $assignment->assign_id) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <select class="form-control @error('emp_id') is-invalid @enderror" 
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->emp_id }}" 
                                        {{ old('emp_id', $assignment->emp_id) == $emp->emp_id ? 'selected' : '' }}>
                            ...
                            <select class="form-control @error('proj_id') is-invalid @enderror" 
                                ...
                                @foreach($projects as $proj)
                                    <option value="{{ $proj->proj_id }}" 
                                        {{ old('proj_id', $assignment->proj_id) == $proj->proj_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('role') is-invalid @enderror" 
                                   id="role" name="role" value="{{ old('role', $assignment->role) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('hours') is-invalid @enderror" 
                                   id="hours" name="hours" value="{{ old('hours', $assignment->hours) }}" 
